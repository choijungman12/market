...
${a?"CTA 느낌, 결심하는 인물":r?"스크롤 멈추는 충격적 장면":"진지한 정보 전달"}`;return await h(c)||""}async function $(e){await s(e),localStorage.removeItem("hookflow_history")}async function A(){let e=new Date().toLocaleDateString("ko-KR"),t=await g(`한국/글로벌 YouTube\xb7SNS 바이럴 영상 분석 전문가.
