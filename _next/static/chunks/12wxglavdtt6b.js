...
[{"headline":"","subheadline":"","bodyPoints":["","","","",""],"callToAction":"","targetAudience":""}]`,{temp:.3,max:8e3,webSearch:!0}));return Array.isArray(o)?o:[o]}async function S(e,t=5){let r=m(await g(`당신은 한국 SNS 바이럴 콘텐츠 작가입니다.
...
]`,{temp:.7,max:8e3}));return Array.isArray(r)?r:[r]}async function v(e,t="instagram"){if(!p())return e.map(()=>"");let r={instagram:"정사각형 1:1",tiktok:"세로 9:16",facebook:"가로 16:9"},n=Array(e.length).fill("");for(let a=0;a<e.length;a+=2){let o=e.slice(a,a+2).map((o,i)=>{let s=a+i,l=String(o.title||""),c=String(o.subtitle||""),d=String(o.textEmphasis||l),u=String(o.imagePrompt||""),f=String(o.colorScheme||""),p=s===e.length-1;return h(`한국 SNS 콘텐츠 이미지 생성.
