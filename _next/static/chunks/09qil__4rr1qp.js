...
]`,{temp:.6,max:8e3}));return Array.isArray(o)?o:[o]}async function S(e,t="instagram"){if(!p())return e.map(()=>"");let r={instagram:"정사각형 1:1",tiktok:"세로 9:16",facebook:"가로 16:9"},o=Array(e.length).fill("");for(let n=0;n<e.length;n+=2){let a=e.slice(n,n+2).map((a,i)=>{let l=String(a.title||""),s=String(a.subtitle||""),c=String(a.textEmphasis||l),d=String(a.imagePrompt||""),u=String(a.colorScheme||""),f=n+i===e.length-1;return g(`한국 SNS 콘텐츠 이미지 생성.
