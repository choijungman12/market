...
]`,{temp:.6,max:8e3}));return Array.isArray(n)?n:[n]}async function v(e,t="instagram"){if(!p())return e.map(()=>"");let r={instagram:"정사각형 1:1",tiktok:"세로 9:16",facebook:"가로 16:9"},n=Array(e.length).fill("");for(let a=0;a<e.length;a+=2){let o=e.slice(a,a+2).map((o,i)=>{let s=String(o.title||""),l=String(o.subtitle||""),c=String(o.textEmphasis||s),d=String(o.imagePrompt||""),u=String(o.colorScheme||""),f=a+i===e.length-1;return h(`한국 SNS 콘텐츠 이미지 생성.
